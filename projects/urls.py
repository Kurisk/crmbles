...
urlpatterns = [
    ...
    path('tasks/notes/<int:note_id>/update/', views.task_note_update, name='task_note_update'),
    path('tasks/notes/<int:note_id>/delete/', views.task_note_delete, name='task_note_delete'),
